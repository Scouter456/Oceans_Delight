...
public class ODBlocks {
    ...
    public static final RegistryObject<Block> GUARDIAN_SOUP = BLOCKS.register("guardian_soup", () -> new GuardianSoupBlock(BlockBehaviour.Properties.copy(Blocks.IRON_BLOCK)
