...
public class LanguageGenerator extends LanguageProvider {
    public LanguageGenerator(DataGenerator gen){
        super(gen.getPackOutput(), OceansDelight.MODID, "en_us");
    }
    ...
    protected void addTranslations(){
        ...
        addItem(ODItems.COOKED_STUFFED_SQUID, "Cooked Stuffed Squid");
        addItem(ODItems.STUFFED_SQUID, "Stuffed Squid");
        addItem(ODItems.KELP_ENCRUSTED_COD, "Kelp Encrusted Cod");

        //TABS
        addTabName(ODTabs.OD_TAB.get(), "Ocean's Delight");
    }
